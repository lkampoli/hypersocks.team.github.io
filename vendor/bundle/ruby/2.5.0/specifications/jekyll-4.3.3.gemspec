...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jekyll-sass-converter>.freeze, ["< 4.0", ">= 2.0"])
      s.add_runtime_dependency(%q<jekyll-watch>.freeze, ["~> 2.0"])
      s.add_runtime_dependency(%q<kramdown>.freeze, [">= 2.3.1", "~> 2.3"])
      s.add_runtime_dependency(%q<kramdown-parser-gfm>.freeze, ["~> 1.0"])
      s.add_runtime_dependency(%q<liquid>.freeze, ["~> 4.0"])
      s.add_runtime_dependency(%q<mercenary>.freeze, ["< 0.5", ">= 0.3.6"])
      s.add_runtime_dependency(%q<pathutil>.freeze, ["~> 0.9"])
      s.add_runtime_dependency(%q<rouge>.freeze, ["< 5.0", ">= 3.0"])
      s.add_runtime_dependency(%q<safe_yaml>.freeze, ["~> 1.0"])
      s.add_runtime_dependency(%q<terminal-table>.freeze, ["< 4.0", ">= 1.8"])
      ...
      s.add_dependency(%q<jekyll-sass-converter>.freeze, ["< 4.0", ">= 2.0"])
      s.add_dependency(%q<jekyll-watch>.freeze, ["~> 2.0"])
      s.add_dependency(%q<kramdown>.freeze, [">= 2.3.1", "~> 2.3"])
      s.add_dependency(%q<kramdown-parser-gfm>.freeze, ["~> 1.0"])
      s.add_dependency(%q<liquid>.freeze, ["~> 4.0"])
      s.add_dependency(%q<mercenary>.freeze, ["< 0.5", ">= 0.3.6"])
      s.add_dependency(%q<pathutil>.freeze, ["~> 0.9"])
      s.add_dependency(%q<rouge>.freeze, ["< 5.0", ">= 3.0"])
      s.add_dependency(%q<safe_yaml>.freeze, ["~> 1.0"])
      s.add_dependency(%q<terminal-table>.freeze, ["< 4.0", ">= 1.8"])
